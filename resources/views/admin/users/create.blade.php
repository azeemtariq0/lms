...
<!-- 
                <div>
                    ...
                    <div>
                                ...
                                <div class="flex items-center mb-1">
                                    <input id="is_mollim" type="checkbox" class="form-checkbox"
                                        name="is_mollim" value="1"
                                        {{ (isset($user->is_mollim) && $user->is_mollim==1) ? 'checked' : '' }}>
                                    <label for="is_mollim"
                                        class=" ml-1 text-sm text-gray-800">Is Mollim</label>
                                </div>
            ...
            <form action="#">
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" autocomplete="off" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Username" required="">
                    </div>
