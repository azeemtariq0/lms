                ...
                <div>
                    ...
                    <div class="relative">
                        <input id="email" type="email"
                            class=" w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#023c40] @error('email') border-red-500 @enderror"
                ...
                <div>
                    ...
                    <div class="relative">
                        <input id="password" type="password"
                            class=" w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#023c40] @error('password') border-red-500 @enderror"
                ...
                <div class="flex items-center justify-between">
                    ...
                    @if (Route::has('password.request'))
                        <a href="{{ route('password.request') }}"
                            class="text-sm text-blue-600 hover:underline">{{ __('Forgot Password?') }}</a>
                    @endif
                </div>

                <button type="submit"
                    class="w-full py-2 bg-[#023c40] text-white font-semibold rounded-lg hover:bg-[#023c40] focus:ring-2 focus:ring-[#023c40]/50">
                    {{ __('Sign In') }}
                </button>
            </form>
        </div>
